...
| 3 | File knobs set and step 0b done | `FORTEL2_ENV=.env.sepolia FORCE_SEPOLIA_REDEPLOY=1 ./scripts/02-deploy-contracts-sepolia.sh` — pairs `ADMIN_PRIVATE_KEY` to `ADMIN_ADDRESS` first (F7-10); a mismatch aborts before `rm -rf` | **US-071** |
