...
| **US-071** | Announce (≥1 day) + stop writers + redeploy Sepolia L1 + new genesis | **In progress — step 1 done** (notice 2026-08-21 20:00Z, D-0067). Step 2 gated on **2026-08-22T20:00Z**; run `scripts/phase7-preflight.sh` first — operator |
