...
- Establish a phase roadmap that explicitly sequences: bridging, pipeline viewer, Phase 2 funding gate, Sepolia migration, Render replica (stock clients), **friend-operated distributed nodes**, per-component reimplementation (batcher → proposer → derivation), fault proofs, decentralized sequencer
