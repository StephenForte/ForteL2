...
- File: `ethers-6.13.7.min.js` (self-contained ESM from npm `dist/ethers.min.js`; filename tracks the vendored version — bump it and the import paths in `dapp/app.js` / `viewer/app.js` / `blocks/app.js` together)
