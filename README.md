...
| **EL** | **op-geth → op-reth** (parallel; not a phase number) | **Tasks 1–6 done — cutover 2026-09-02, promoted 2026-09-06 (D-0122)** (block 473032, [D-0120](tasks/decisions.md)); [`tasks/prd-op-reth-migration.md`](tasks/prd-op-reth-migration.md); promoted ([D-0122](tasks/decisions.md), 2026-09-06); Task 7 Render replica next |
