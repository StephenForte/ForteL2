...
# explicit opt-in (D-0124, #210) — all three, verifier only, never the live sequencer:
#   FORTEL2_ALLOW_PUBLICNODE_L1=1 SEPOLIA_L1_RPC_KIND=standard FORTEL2_RETH_PROFILE=verifier
