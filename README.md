...
| **7** | **Fault proofs**: run op-challenger, exercise a dispute game against a deliberately bad proposal — begins with a **coordinated redeploy** (all new fault-game immutables chosen in one sitting) + network-wide reset | In progress — redeploy done 2026-08-22 (D-0068); type-8 game registered and respected (D-0077); challenger live, valid game watched unattacked (D-0082); outstanding: deliberate bad proposal + closeout. Spec [`tasks/prd-phase-7-fault-proofs.md`](tasks/prd-phase-7-fault-proofs.md) (do not execute the wipe from this row) |
