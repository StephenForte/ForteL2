...
> The SOS recovery (PRD step 10) is also **complete** — D-0069. Outstanding: **step 8b** (fault-proof game; its F7-12 precondition landed in #118, so it is unblocked) and steps **11–13** (stock proposer posts a valid game, deliberate bad proposal, closeout note).
