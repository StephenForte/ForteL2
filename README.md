...
| Funding-gate second-opinion L1 | PublicNode (one-shot at the pinned block; **not** serving traffic — D-0106) | `SEPOLIA_L1_CORROBORATION_RPC_URL` (must differ from `L1_RPC_URL`; default `https://ethereum-sepolia-rpc.publicnode.com`) |
